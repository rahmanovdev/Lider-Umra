...
const Footer = () => {
  ...
  // Мамыча (state) Ош жана Бишкек телефон номерлери үчүн, тип менен аныкталган
  const [selectedCity, setSelectedCity] = useState<City | null>(null);

  // Телефон номерлери, стринг массив катары аныкталган
  const phoneNumbers: Record<City, string[]> = {
    osh: ['+996 555 123 456', '+996 555 789 012'], // Ош шаарынын мисал номерлери
    bishkek: ['+996 312 123 456', '+996 312 789 012'], // Бишкек шаарынын мисал номерлери
  };
    ...
    >
      ...
      <div className={scss.under_footer}>
        ...
        <div className={scss.right}>
          <p>
            <span>IANT Studio</span> тарабынан жасалды
          </p>
        </div>
      </div>
    </footer>
